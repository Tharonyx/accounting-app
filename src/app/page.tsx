"use client";
import { MessageSquare, Bell, Search, Edit, Calendar as CalendarIcon } from "lucide-react";
      ...
      <div className="bg-white shadow-none ">
        <nav className="flex flex-wrap items-center justify-between gap-4 md:gap-0 p-4">
          ...
          <div className="flex-shrink-0 w-full md:w-auto">
            <Card className="w-full md:w-[250px] shadow-none border-none">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 border-r mr-0 p-4 ml-16 md:ml-0">
                  ...
                  <form>
                    <div className="grid items-center gap-1">
                      <div className="flex flex-col space-y-1">
                        ...
                        <Select>
                          <SelectTrigger id="framework" className="border-0 p-1 h-8 text-sm">
                  ...
                  <form>
                    <div className="grid items-center gap-1">
                      <div className="flex flex-col space-y-1">
                        ...
                        <Select>
                          <SelectTrigger id="currency" className="border-0 p-1 h-8 text-sm">
          ...
          <div className="mt-4">
            ...
            <div className="mt-8 ml-0 md:ml-8">
              <div className="flex justify-between">
                ...
                <div className="mr-0 md:mr-8 flex">
                    ...
                    <form>
                      <div className="grid items-center gap-1">
                        <div className="flex flex-col space-y-1">
                          ...
                          <Select>
                            <SelectTrigger id="documentType" className="border-0 p-1 h-8 text-sm">
                    ...
                    <form>
                      <div className="grid items-center gap-1">
                        <div className="flex flex-col space-y-1">
                          ...
                          <Select>
                            <SelectTrigger id="document" className="border-0 p-1 h-8 text-sm">
                ...
                <div className="p-4">
                  <Popover>
                    <PopoverTrigger asChild>
                      <Button
                        variant="outline"
                        className="flex justify-between space-x-2 w-full text-left font-normal p-6 border border-gray-300 rounded-xl"
                      >
                        {selectedDate ? (
          ...
          <div className="flex gap-2 justify-between mr-3 mt-4">
            ...
            <Badge className="border border-gray-300 rounded-xl p-2 text-gray-400 bg-gray-200 text-base">Badge 4</Badge>
          </div>
        </div>
          ...
          <div className="m-0 md:m-8 border-0 shadow-md bg-white p-4">
            ...
            <div className="mb-14">
              <div className="text-sm">
                <p>Invoice: <span className="font-bold text-black ml-7">FV 00001/09/2022</span></p>
